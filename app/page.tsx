    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white font-sans">
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-[#0a0a0f]/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-violet-600 flex items-center justify-center">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path d="M2 4h5v5H2zM9 7h5v5H9zM4 2h3v3H4z" fill="white" opacity="0.9"/>
              </svg>
            </div>
            <span className="font-semibold text-lg tracking-tight">CloudSketch</span>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link href="/Visuel" className="text-sm bg-white text-black font-medium px-4 py-2 rounded-lg hover:bg-white/90 transition-all">
              Start for free →
            </Link>
          </div>

          {/* Mobile menu btn */}
          <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="md:hidden text-white/60">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <div className="relative rounded-2xl border border-white/10 overflow-hidden bg-[#111118] shadow-2xl shadow-black/50">
            ...
            <div className="flex items-center gap-2 px-4 py-3 border-b border-white/5 bg-[#0d0d14]">
              ...
              <span className="ml-3 text-xs text-white/20">CloudSketch — main.tf</span>
            </div>
            {/* Fake canvas */}
            <div className="h-72 md:h-96 relative overflow-hidden">
              ...
              <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{opacity: 0.3}}>
                <line x1="200" y1="60" x2="350" y2="100" stroke="#6366f1" strokeWidth="1.5" strokeDasharray="4"/>
                <line x1="420" y1="120" x2="480" y2="160" stroke="#22c55e" strokeWidth="1.5" strokeDasharray="4"/>
                <line x1="500" y1="80" x2="600" y2="80" stroke="#f59e0b" strokeWidth="1.5" strokeDasharray="4"/>
              </svg>
      ...
      <section className="py-12 border-y border-white/5 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-sm text-white/30 mb-8">Trusted by infrastructure teams at</p>
          <div className="flex flex-wrap items-center justify-center gap-10 text-white/20 font-semibold text-sm tracking-widest uppercase">
            {["Accenture", "Devoteam", "Sopra Steria", "Capgemini", "Scaleway"].map(name => (
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Everything you need to<br/>understand your infrastructure
            </h2>
            <p className="text-white/40 text-lg max-w-xl mx-auto">
              From HCL to diagram in seconds. Built for DevOps engineers, architects and platform teams.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              <div key={title} className="p-6 rounded-2xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-all group">
                <div className={`w-10 h-10 rounded-xl bg-${color}-500/10 border border-${color}-500/20 flex items-center justify-center text-xl mb-4 group-hover:scale-110 transition-transform`}>
                  {icon}
                </div>
      ...
      <section id="how-it-works" className="py-24 px-6 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              { step: "01", title: "Paste your Terraform", desc: "Copy any `.tf` file into CloudSketch. Modules, variables, multi-file — all supported." },
              { step: "02", title: "Get your diagram", desc: "Resources appear as interactive nodes. Relations are drawn automatically from your references." },
              { step: "03", title: "Share or export", desc: "Export as image or share a live link with your team. No account needed to view." },
            ].map(({ step, title, desc }) => (
              <div key={step} className="flex gap-8 items-start p-6 rounded-2xl border border-white/5 hover:border-white/10 transition-all">
                <span className="text-4xl font-bold text-white/10 tabular-nums shrink-0">{step}</span>
                <div>
            ...
            {[
              {
                ...
                features: ["5 diagrams", "Azure & AWS nodes", "PNG export", "Community support"],
                cta: "Get started",
                highlighted: false,
              },
              {
                ...
                features: ["Unlimited diagrams", "All cloud providers", "SVG + PDF export", "Share links", "Priority support"],
              ...
              },
              {
                ...
                features: ["Everything in Pro", "Real-time collaboration", "Version history", "SSO / SAML", "Dedicated support"],
                cta: "Contact us",
                highlighted: false,
              },
            ].map(({ name, price, period, desc, features, cta, highlighted }) => (
              <div key={name} className={`p-6 rounded-2xl border flex flex-col ${highlighted ? "border-blue-500/50 bg-blue-500/5" : "border-white/5 bg-white/[0.02]"}`}>
                {highlighted && (
      ...
      <section className="py-24 px-6 border-t border-white/5">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-white/40 mb-10 text-lg">
            Join 2,000+ infrastructure engineers who switched from spreadsheets to CloudSketch.
          </p>
          <Link 
            href="/Visuel"
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start justify-between gap-8">
          ...
          <div className="grid grid-cols-3 gap-12 text-sm">
            {[
              ...
              { title: "Resources", links: ["Docs", "Blog", "Examples", "Status"] },
              ...
              <div key={title}>
                ...
                <ul className="space-y-3">
                  {links.map(link => (
                    <li key={link}>
                      <a href="#" className="text-white/30 hover:text-white/60 transition-colors">{link}</a>
                    </li>
                  ))}
                </ul>
              </div>
